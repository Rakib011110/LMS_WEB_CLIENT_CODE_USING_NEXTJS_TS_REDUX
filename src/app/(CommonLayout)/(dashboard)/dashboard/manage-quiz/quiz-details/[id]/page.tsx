      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-8">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4 border-t border-gray-200">
              ...
              <div className="text-center">
                <p className="text-2xl font-bold text-red-600">{quiz.negativeMarkingPercentage}%</p>
        ...
        <div className="space-y-6">
          {questions.map((question, index) => (
            <Card key={question._id} className="space-y-4">
        ...
        <Card className="mt-8 sticky bottom-4">
          <div className="flex justify-between items-center">
            <div className="text-sm text-gray-600">
              <p>Questions answered: {answeredCount} of {totalQuestions}</p>
            ...
            <div className="flex gap-4">
              ...
              <button 
                ...
                className="flex items-center gap-2 px-6 py-2 bg-green-600 text-white font-semibold rounded-lg shadow-md hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <Send size={18} />
