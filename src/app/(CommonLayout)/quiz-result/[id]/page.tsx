      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="mb-8">
          <div className="text-center mb-6">
            <div className={`inline-flex items-center justify-center w-32 h-32 rounded-full ${getScoreBgColor(result.percentage)} mb-4`}>
              <div className="text-center">
                <span className={`text-4xl font-bold ${getScoreColor(result.percentage)} block`}>
                      ...
                      {questionResult.feedback && (
                        <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded">
                          <p className="text-blue-800 text-sm">
                            <strong>Explanation:</strong> {questionResult.feedback}
                          </p>
                        </div>
                      )}
                    </div>
